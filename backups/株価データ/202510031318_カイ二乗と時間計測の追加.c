...
int main()
{
    ...
    for (trial = Nstart; trial < (Nstart + Ntry); trial++)
    {
        ...
        printf("\nTrial %d completed:\n", trial - Nstart + 1);
        printf("  File: %s\n", state.filename_rule);
        printf("  Rules: %d (High-support: %d, Low-variance: %d, High-chi-square: %d)\n",
               state.rule_count - 1,
               state.high_support_rule_count - 1,
               state.low_variance_rule_count - 1,
               state.high_chi_square_rule_count - 1);
        ...
        total_high_chi_square += state.high_chi_square_rule_count - 1;

        printf("  Cumulative total: %d rules (High-support: %d, Low-variance: %d, High-chi-square: %d)\n",
               total_rule_count, total_high_support, total_low_variance, total_high_chi_square);
