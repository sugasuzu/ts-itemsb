...
/* 2024-1-16 ITディレクトリ削除、ヘッダー追加、文字化け対策 */
...
#define fpoola "output/pool/zrp01a.txt" /* 出力: グローバルルールプール（属性ID版） \
                                           属性番号で記録（文字化け回避） */
...
int main()
{
    ...
    FILE *file_pool_attribute; /* グローバルプール（属性ID版） */
